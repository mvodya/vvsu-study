...
- [Переменные и инициализация](#переменные-и-инициализация)
- [const](#const)
- [auto](#auto)
- [Условия](#условия)
  - [if](#if)
...
- [Потоки ввода и вывода](#потоки-ввода-и-вывода)
- [Работа с файлами](#работа-с-файлами)
  - [Чтение](#чтение)
  - [Запись](#запись)
  - [Добавление в конец файла](#добавление-в-конец-файла)
  - [Явное закрытие](#явное-закрытие)
  - [Пути к файлам](#пути-к-файлам)
- [Чтение структурированных данных](#чтение-структурированных-данных)
- [Построчное чтение](#построчное-чтение)
- [std::istringstream](#stdistringstream)
- [Парсинг с разделителем](#парсинг-с-разделителем)
- [Преобразование числового поля в bool](#преобразование-числового-поля-в-bool)
- [Namespace](#namespace)
- [Заголовочные и исходные файлы](#заголовочные-и-исходные-файлы)
  - [math\.hpp](#mathhpp)
  - [math\.cpp](#mathcpp)
  - [main\.cpp](#maincpp)
- [\#include](#include)
...
- [Объявление, определение и символ](#объявление-определение-и-символ)
- [Ошибки компоновки](#ошибки-компоновки)
  - [undefined reference](#undefined-reference)
  - [multiple definition](#multiple-definition)
- [One Definition Rule](#one-definition-rule)
- [Связывание имен](#связывание-имен)
- [Ошибки и предупреждения при сборке](#ошибки-и-предупреждения-при-сборке)
- [Базовая работа с отладчиком](#базовая-работа-с-отладчиком)
